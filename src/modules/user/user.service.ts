...
import { DeleteDao,UpdateDao} from "../../database/dao/user.dao";
...
const deleteSVc = (id:any)=>{
  return DeleteDao(id)
}
const updatesvc = (id:any,Updatedata:any)=>{
  return UpdateDao(id,Updatedata)
}

export { userRegisterSvc,deleteSVc,updatesvc};
